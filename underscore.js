...
// Bonus Points
const totalByMonth = _.reduce(purchasesByMonth, ); // Use the groupded purchasesByMonth and reduce to create a totalByMonth object.
...
var fastFibonnaci = memoize((n) => {
  return n < 2 ? n: slowFibonnaci(n - 1) + slowFibonnaci(n - 2);
})

let slowN = 243;
console.time('slowFibonnaci:' + fastN)
console.log(slowFibonnaci(fastN));
console.timeEnd('slowFibonnaci:' + fastN);
